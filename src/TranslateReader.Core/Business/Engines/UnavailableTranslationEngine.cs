...
/// <see cref="PlatformNotSupportedException"/> from its own static constructor on these platforms
/// (D-2026-08-16-llm-mobile-5). Registering this in place of the real engine is what removes that
/// crash entirely: the type is never touched, so the static constructor never runs.
/// </summary>
