...
- [ ] Suite INTEIRA sem regressao: `Failed: 0`, `Total >= B+5` e `Skipped <= S` com `B` (`[Fact` +
      ...
      `Total >= 343`). Ancora = `$(git merge-base origin/main HEAD)` por
      `D-2026-08-01-translated-epub-images-10` (o ref LOCAL `main` saiu: velho afrouxa o piso,
      ausente esvazia o gate). Pre-requisito: clone com `origin/main` e historia
      (`fetch-depth: 0`).
      ...
      **Source:** CONTEXT (D-...-8, SUPERSEDIDA por D-...-9(A); ancora por D-...-10)
